...
/**
 * Created by siris on 10/17/2016.
 */
public class WelcomeAdpter extends RecyclerView.Adapter<WelcomeAdpter.MyViewHolder> {

    ArrayList<String> welcomeArray=new ArrayList<>();
    ArrayList<Integer> welcomeIcons=new ArrayList<>();
    Context c;
    ...
    public WelcomeAdpter(ArrayList<String> welcomeArray,Integer ImageName[],  Context c) {
    ...
    @Override
    public void onBindViewHolder(WelcomeAdpter.MyViewHolder holder, int position) {
