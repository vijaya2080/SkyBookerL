...
public class RoundTripFlights extends AppCompatActivity implements RoundTripFlightsCustomAdapter.OnSecurityQnClickListener,PopupAdapter.OnSecurityQnClickListener{
    ...
    RoundTripFlightsCustomAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_of_related_flights);


        toolbarlayout=(RelativeLayout)findViewById(R.id.relatedFlightsToolBar);
        ...
        pagerLayout=(LinearLayout)findViewById(R.id.flitersLay);
        sortLayout=(RelativeLayout)pagerLayout.findViewById(R.id.sortLayout);
        filtersLayout=(RelativeLayout)pagerLayout.findViewById(R.id.filtersLayout);
        nearLayout=(RelativeLayout)pagerLayout.findViewById(R.id.nearbyLayout);
        flexibleLayout=(RelativeLayout)pagerLayout.findViewById(R.id.flexibleLayout);
        ...
        sortLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
             ...
             popupView = layoutInflater.inflate(R.layout.popup_recycler, null);
                ...
                adpt.setOnSecurityQnClickListener(RoundTripFlights.this);
           ...
           popupWindow = new PopupWindow(
                ...
                flexibleLayout.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        startActivity(new Intent(RoundTripFlights.this,FlexibleDates.class));
                    }
                });
        ...
        filtersLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(RoundTripFlights.this,FiltersActivity.class));
            }
        });
        ...
        relatedFlightsRv=(RecyclerView)findViewById(R.id.relatedFlightsRv);
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(this);
        relatedFlightsRv.setLayoutManager(layoutManager);
        relatedFlightsRv.setItemAnimator(new DefaultItemAnimator());
        adapter=new RoundTripFlightsCustomAdapter(RoundTripFlights.this,fromCityArray,toCityArray);
    ...
    public void onSecurityQnClick(View view, int position) throws ClassNotFoundException, IOException, DecoderException {
        ...
        startActivity(new Intent(RoundTripFlights.this, ReviewActivity.class));
    }
}
